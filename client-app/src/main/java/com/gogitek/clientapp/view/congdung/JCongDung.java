...
public class JCongDung extends javax.swing.JFrame {
    ...
    public void initData() {
        ...
        try {
            SocketConnection socketConnection = congDungService.findListCongDungByKey("");
            list = JsonUtils.stringToArray(socketConnection.getResult().toString(), CongDung[].class);
    ...
    private void initComponents() {
        ...
        inputName.addActionListener(this::inputNameActionPerformed);
    ...
    private void btnRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRefreshActionPerformed
        ...
        model.setRowCount(0);
        List<CongDung> list = new ArrayList<>();
        try {SocketConnection socketConnection = congDungService.findListCongDungByKey("");
            list = JsonUtils.stringToArray(socketConnection.getResult().toString(), CongDung[].class);
            socketConnection.closeConnection();
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try {
            ...
            listCongDung = JsonUtils.stringToArray(socketConnection.getResult().toString(), CongDung[].class);
        } catch (Exception ex) {
            ex.printStackTrace();
        }   
    ...
    private void tableCongDungMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableCongDungMouseClicked
        ...
        CongDung congDung = new CongDung((String)v.get(0), (String)v.get(1), (String)v.get(2), (String)v.get(3));
        (new JEditCongDung(congDung)).setVisible(true);
        setVisible(false);
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(() -> new JCongDung().setVisible(true));
    }
