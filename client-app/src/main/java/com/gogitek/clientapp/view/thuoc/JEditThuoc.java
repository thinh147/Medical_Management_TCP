        ...
        if (maThuoc.length() <= 15 && maThuoc.matches("\\w+")) {
            if (tenThuoc.length() <= 50) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "Giá thuốc phải là dạng số");
                ...
                JOptionPane.showMessageDialog(this, "Tên thuốc không đúng kích thước hoặc chứa ký tự đặc biệt");
                inputTenThuoc.requestFocus();
            }
        } else {
            JOptionPane.showMessageDialog(this, "Mã thuốc không đúng kích thước hoặc chứa ký tự đặc biệt");
